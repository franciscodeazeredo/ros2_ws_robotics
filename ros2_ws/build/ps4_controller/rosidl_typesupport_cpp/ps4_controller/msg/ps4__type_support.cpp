...
static const _PS4_type_support_symbol_names_t _PS4_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ps4_controller, msg, PS4)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ps4_controller, msg, PS4)),
  }
};
...
{
  return &::ps4_controller::msg::rosidl_typesupport_cpp::PS4_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ps4_controller, msg, PS4)() {
  return get_message_type_support_handle<ps4_controller::msg::PS4>();
}
