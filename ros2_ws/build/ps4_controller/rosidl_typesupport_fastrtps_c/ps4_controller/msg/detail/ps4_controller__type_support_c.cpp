...
#include "ps4_controller/msg/detail/ps4_controller__rosidl_typesupport_fastrtps_c.h"
...
using _Ps4Controller__ros_msg_type = ps4_controller__msg__Ps4Controller;
...
size_t get_serialized_size_ps4_controller__msg__Ps4Controller(
  const void * untyped_ros_message,
...
static uint32_t _Ps4Controller__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ps4_controller__msg__Ps4Controller(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ps4_controller
size_t max_serialized_size_ps4_controller__msg__Ps4Controller(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ps4_controller__msg__Ps4Controller;
    is_plain =
      (
...
static size_t _Ps4Controller__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ps4_controller__msg__Ps4Controller(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ps4_controller, msg, Ps4Controller)() {
