...
#include "ps4_controller/msg/detail/ps4_controller__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ps4_controller::msg::Ps4Controller;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ps4_controller::msg::Ps4Controller *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ps4_controller::msg::Ps4Controller *>(
    untyped_ros_message);
...
static size_t _Ps4Controller__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ps4Controller(full_bounded, is_plain, 0);
...
{
  return &ps4_controller::msg::typesupport_fastrtps_cpp::_Ps4Controller__handle;
}
