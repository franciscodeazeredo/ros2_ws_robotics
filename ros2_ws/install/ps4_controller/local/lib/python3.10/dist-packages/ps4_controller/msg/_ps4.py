...
class Metaclass_PS4(type):
    """Metaclass of message 'PS4'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ps4_controller.msg.PS4')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ps4
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ps4
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ps4
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ps4
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ps4
...
class PS4(metaclass=Metaclass_PS4):
    """Message class 'PS4'."""
