...
tutorial_interfaces__msg__Num__init(tutorial_interfaces__msg__Num * msg)
{
  ...
  // buttons
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->buttons, 0)) {
    tutorial_interfaces__msg__Num__fini(msg);
    return false;
  }
  // numpad
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->numpad, 0)) {
    tutorial_interfaces__msg__Num__fini(msg);
    return false;
  }
  return true;
...
tutorial_interfaces__msg__Num__fini(tutorial_interfaces__msg__Num * msg)
{
  ...
  // buttons
  rosidl_runtime_c__int64__Sequence__fini(&msg->buttons);
  // numpad
  rosidl_runtime_c__int64__Sequence__fini(&msg->numpad);
}
